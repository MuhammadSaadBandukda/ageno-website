    ...
    <>
      ...
      />
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 ">
          <WebApplicaion/>
          <HeroSection topLine="Turning Ideas Into Impactful Digital Solutions" mainText="We don't just build projects - we build partnerships. Our approach combines learning, teaching, and innovation to create solutions that help your business grow and stand out in a fast-changing world." image="https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"/>
          <DesktopApplication/>
          <HeroSectionAlternate topLine="Turning Ideas Into Impactful Digital Solutions" mainText="We don't just build projects - we build partnerships. Our approach combines learning, teaching, and innovation to create solutions that help your business grow and stand out in a fast-changing world." image="https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"/>
          <AgenticApplication/>
          <WhyChooseUs/>
          {/* WEBAPPLICTAION  */}
          {/* MOBILE APPLICATIOON  */}
