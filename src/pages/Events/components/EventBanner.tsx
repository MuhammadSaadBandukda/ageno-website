    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-300 dark:border-gray-700 shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col md:flex-row overflow-hidden p-4 md:p-6 max-w-6xl mx-auto">
      ...
      <div className="flex-shrink-0 w-full md:w-1/3">
        <img
          src={event.image}
          alt={event.title}
          className="h-48 md:h-full w-full object-cover rounded-xl"
        />
      </div>

      {/* Event Info */}
      <div className="flex-grow max-w-xl px-4 py-4 md:py-2 md:px-8 flex flex-col justify-center">
        <span className="bg-gray-200 dark:bg-gray-700 text-sm text-gray-700 dark:text-gray-200 px-3 py-1 rounded-full w-fit mb-2">
          {event.category}
        </span>
      ...
      <div className="flex flex-col justify-center  mt-4 md:mt-0 md:ml-auto">
        ...
        <Link
          ...
          className={isPast ? "text-center font-semibold text-sm text-gray-700 dark:text-gray-200 hover:underline" : "mt-2 text-center font-semibold text-sm text-gray-700 dark:text-gray-200 hover:underline"}
        >
          See Details
        </Link>
      </div>
