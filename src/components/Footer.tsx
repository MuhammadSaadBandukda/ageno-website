...
const Footer = () => {
  return (
    <div className="bg-white dark:bg-zinc-800 dark:text-gray-400 space-y-12">
    <div className="grid grid-cols-12  mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="col-span-2">
        ...
        <ul className="space-y-3">
          ...
          <li className="hover:underline dark:hover:text-white">
            <Link to="https://x.com/agenoverse">X(formerly Twitter)</Link>
          </li>
          <li className="hover:underline dark:hover:text-white">
